        ...
        <nav class="px-2 sm:px-4 py-2.5 shadow m-auto">
            <div class="flex flex-wrap justify-between items-center mx-auto md:max-w-screen-xl">
                <a href="https://creative-arcades.com" class="flex items-center">
                    <img src={Logo} class="h-18 w-44" alt="Creative Arcades Logo" />
                </a>
                <div class="flex md:order-2">
                    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0">Back to Website</button>
