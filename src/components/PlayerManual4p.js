...
import image4 from './imgs/6296manual4p.png'
                ...
                <div class="p-4 md:p-0 w-screen md:max-w-screen-lg flex grid gap-4 grid-cols-2 md:grid-cols-3 m-auto">
                    <div class="m-auto">
                        <a href={pdf1} target="_blank" rel="noopener noreferrer">
                            <img src={image1} class="w-44 h-22 md:w-80 md:h-44 rounded-lg md:hover:opacity-80" alt="4500 Games" />
                        </a>
                    </div>
                    <div class="m-auto">
                        <a href="" target="_blank" rel="noopener noreferrer">
                            <img src={image4} class="w-44 h-22 md:w-80 md:h-44 rounded-lg md:hover:opacity-80" alt="6296 Games" />
                        </a>
                    </div>
                    <div class="m-auto">
                        <a href={pdf2} target="_blank" rel="noopener noreferrer">
                            <img src={image2} class="w-44 h-22 md:w-80 md:h-44 rounded-lg md:hover:opacity-80" alt="9403 Games" />
                        </a>
                    </div>
                    <div class="m-auto">
                        <a href={pdf3} target="_blank" rel="noopener noreferrer">
                            <img src={image3} class="w-44 h-22 md:w-80 md:h-44 rounded-lg md:hover:opacity-80" alt="Slim Button Layout" />
                        </a>
                    </div>
                </div>
            </div>
